    ...
    <section id="demo" className="py-20 bg-white" ref={ref}>
      <div className="site-container">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Demo Video</h2>
          <p className="section-subtitle max-w-4xl mx-auto text-center">
            See how <span className="font-semibold">Duo Flip</span> transforms classrooms with hands-on,
            collaborative activities and real-time feedback. Watch the demo to experience the future of learning.
          </p>
        </motion.div>
        ...
        >
          <motion.div
            ...
            style={{
              backgroundImage:
                showModalVideo
                  ? "none"
                  : "url(https://images.unsplash.com/photo-1509062522246-3755977927d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600)",
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Our demonstration video showcases real children using the Duo Flip in various educational settings. See firsthand
              how this innovative technology:
            </p>
