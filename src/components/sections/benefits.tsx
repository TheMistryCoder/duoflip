...
export default function Benefits() {
  ...
  return (
    <section id="benefits" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50" ref={ref}>
      <div className="site-container">
        ...
        >
          ...
          <p className="section-subtitle max-w-4xl mx-auto">
            Proven results in Early Years, Primary classrooms, and SEN environments with measurable improvements in engagement and learning outcomes
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              <motion.div 
                className={`w-16 h-16 bg-gradient-to-br ${benefit.gradient} rounded-full flex items-center justify-center mb-6`}
