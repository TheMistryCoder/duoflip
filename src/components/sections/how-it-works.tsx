      ...
      <div className="site-container">
        ...
        >
          ...
          <p className="section-subtitle max-w-4xl mx-auto">
            Our innovative four-step system makes it simple to create engaging, collaborative learning experiences that adapt to your classroom needs
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              <div className="mb-6">
                <motion.div 
                  className={`w-20 h-20 bg-gradient-to-br ${step.gradient} rounded-full flex items-center justify-center mx-auto transition-transform duration-300`}
              ...
              <h3 className="text-hierarchy-3 mb-3">
                <span className={`bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent font-bold mr-2`}>
                  {index + 1}.
                </span>
                {step.title}
              </h3>
        ...
        >
          <div className="bg-gradient-to-br from-slate-100 to-blue-50 rounded-3xl p-8 text-center">
            <img 
              src="https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&h=600" 
              alt="Interactive projector setup in modern classroom environment" 
