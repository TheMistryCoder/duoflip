...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-slate-800 to-slate-900 text-white" ref={ref}>
      <div className="site-container">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full mb-6">
            <span className="text-sm font-semibold text-white tracking-wider uppercase">Get Started</span>
          </div>
          <h2 className="mb-6 text-white">Ready to Transform Your Classroom?</h2>
          <p className="section-subtitle text-blue-100 max-w-4xl mx-auto">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            ...
                            className="bg-white/10 border-white/30 text-white placeholder-blue-200 focus:ring-sky-500 focus:border-sky-500"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            {...field}
                            placeholder="Head Teacher, SEN Coordinator, etc." 
                            className="bg-white/10 border-white/30 text-white placeholder-blue-200 focus:ring-sky-500 focus:border-sky-500"
                          />
                        </FormControl>
                        <FormMessage />
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          {...field}
                          rows={4}
                          placeholder="Tell us about your specific needs, number of students, or any questions you have..." 
                          className="bg-white/10 border-white/30 text-white placeholder-blue-200 focus:ring-sky-500 focus:border-sky-500 resize-none"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-pink-400 to-amber-400 text-white hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-lg py-6"
                >
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-blue-100 leading-relaxed">
                We'd be delighted to hear from you and help transform learning in your school. Our team provides personalized support to ensure Duo Flip meets your specific educational needs.
              </p>
            </div>
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {info.subtext && (
                      <p className="text-sm text-blue-200 mt-1">{info.subtext}</p>
                    )}
                  </div>
                </motion.div>
              ))}
