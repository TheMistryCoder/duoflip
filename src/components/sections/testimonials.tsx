...
const testimonials = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fA%3D%3D&auto=format&fit=crop&w=100&h=100",
...
export default function Testimonials() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50" ref={ref}>
      <div className="site-container">
        ...
        >
          ...
          <p className="section-subtitle max-w-4xl mx-auto">
            Hear directly from teachers, SEN coordinators, and head teachers about their transformative experiences with Duo Flip
          </p>
        </motion.div>
        ...
        >
                  ...
                  <div className="bg-white rounded-xl p-6 h-full">
                    <div className="flex items-center mb-4">
                      <img 
                        ...
                        className="w-12 h-12 rounded-full mr-4 object-cover ring-2 ring-slate-100" 
                      />
                      <div>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            ...
            <button
              ...
              className="p-2 rounded-full bg-white border border-slate-200 text-slate-600 hover:text-slate-800 transition-all duration-200"
